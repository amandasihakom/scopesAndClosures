...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2? counter1 has private varia
  counter1 holds onto private variables and math that needs to happen. counter2 is like a container for count variables
  2. Which of the two uses a closure? How can you tell?
  counter1 has a closure. You can tell because the second return is wrapped in curly braces.
...
function scoreboard(inningScoreCB, inningCB, numInnings) {
  ...
  if(homeScore === awayScore){
    ...
    scoreByInning.push(`Final Score: Away: ${awayScore.Away} - Home ${homeScore.Home}`);
  }
